        ...
        <div class="flex w-4/5 gap-2"
            ...
            <div class="relative min-w-36"
                ...
                <div class="p-2 mt-2 rounded-b-md border"
                     :class="isCurrentUser ? 'bg-secondary border-secondary text-black rounded-tl-md' : 'bg-primary border-primary text-white rounded-tr-md'">
                    <div class="outline-none whitespace-pre-wrap">
                        <ContentLoader width="256"
                                       height="24"
                                       primary-color="var(--loader-primary)"
                                       secondary-color="var(--loader-secondary)"
                                       :speed="0.8">
                    ...
                    <div class="text-[10px] w-full mt-1 flex"
                         :class="isCurrentUser ? 'text-black justify-start' : 'text-white justify-end'">
                        <ContentLoader width="64"
                                       height="12"
                                       primary-color="var(--loader-primary)"
                                       secondary-color="var(--loader-secondary)"
                                       :speed="0.8">
